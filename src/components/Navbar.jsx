...
const Navbar = () => {
    ...
    <div className="flex justify-between">
      ...
      <div className="flex space-x-4">
        ...
        <div className="hidden md:flex items-center space-x-1">
          <div className="py-5 px-3 text-gray-700 hover:text-gray-900 cursor-pointer" onClick={showBTModal}>Tickets</div>
          <div className="py-5 px-3 text-gray-700 hover:text-gray-900 cursor-pointer" onClick={showBSModal}>Book Stalls</div>
        </div>
      </div>
  ...
  <div className={state ? "mobile-menu":"mobile-menu hidden"}>
    ...
    <Link to="/register" className="block py-2 px-4 text-sm hover:bg-gray-200">Signup</Link>
    <div className="block py-2 px-4 text-sm hover:bg-gray-200" onClick ={showBTModal} >Tickets</div>
    <Link to="/register" className="block py-2 px-4 text-sm hover:bg-gray-200" onClick={showBSModal}>Book stalls</Link>
  </div>
